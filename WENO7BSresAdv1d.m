function res = WENO7resAdv1d(w,flux,dflux,S,dx,N)
% *************************************************************************
...
% Constants
d0 = 1/35; d1 = 12/35; d2 = 18/35; d3 = 4/35; epsilon = 1e-6;

% Alpha weights
alpha0n = d0./(epsilon + B0n).^2;
alpha1n = d1./(epsilon + B1n).^2;
alpha2n = d2./(epsilon + B2n).^2;
alpha3n = d3./(epsilon + B3n).^2;
...
% Constants
d0 = 4/35; d1 = 18/35; d2 = 12/35; d3 = 1/35; epsilon = 1e-6;

% Alpha weights
alpha0p = d0./(epsilon + B0p).^2;
alpha1p = d1./(epsilon + B1p).^2;
alpha2p = d2./(epsilon + B2p).^2;
alpha3p = d3./(epsilon + B3p).^2;
